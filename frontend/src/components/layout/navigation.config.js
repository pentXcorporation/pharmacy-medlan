...
import { ROLES, ADMIN_ROLES, MANAGEMENT_ROLES } from "@/constants";
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        roles: [...ADMIN_ROLES, ROLES.BRANCH_MANAGER],
      },
    ],
  },
  {
    ...
    icon: DollarSign,
    roles: [...ADMIN_ROLES, ROLES.ACCOUNTANT],
    children: [
      {
        title: "Overview",
      ...
      },
      {
        ...
        roles: [...ADMIN_ROLES, ROLES.ACCOUNTANT, ROLES.MANAGER],
      },
      {
        title: "Banks",
        href: ROUTES.FINANCE.BANKS,
        roles: [...ADMIN_ROLES, ROLES.MANAGER],
      },
      {
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        roles: [...ADMIN_ROLES, ROLES.BRANCH_MANAGER, ROLES.MANAGER],
      },
      {
        title: "Audit Trail",
