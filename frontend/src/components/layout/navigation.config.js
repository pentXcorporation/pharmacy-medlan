...
export const NAVIGATION = [
  {
    ...
    roles: [ROLES.SUPER_ADMIN, ROLES.OWNER, ROLES.BRANCH_ADMIN, ROLES.PHARMACIST, ROLES.CASHIER, ROLES.INVENTORY_MANAGER, ROLES.ACCOUNTANT],
  },
  {
    title: 'Point of Sale',
    href: ROUTES.POS.ROOT,
    icon: ShoppingCart,
    roles: [ROLES.SUPER_ADMIN, ROLES.OWNER, ROLES.BRANCH_ADMIN, ROLES.PHARMACIST, ROLES.CASHIER],
    children: [
      {
        title: 'New Sale',
      ...
      },
      {
        ...
        roles: [ROLES.SUPER_ADMIN, ROLES.OWNER, ROLES.BRANCH_ADMIN, ROLES.PHARMACIST],
      },
      {
        title: 'Returns',
  ...
  },
  {
    ...
    icon: Pill,
    roles: [ROLES.SUPER_ADMIN, ROLES.OWNER, ROLES.BRANCH_ADMIN, ROLES.PHARMACIST, ROLES.INVENTORY_MANAGER],
    children: [
      {
        title: 'All Products',
      ...
      },
      {
        ...
        roles: [ROLES.SUPER_ADMIN, ROLES.OWNER, ROLES.BRANCH_ADMIN, ROLES.INVENTORY_MANAGER],
      },
      {
        title: 'Categories',
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        roles: [ROLES.SUPER_ADMIN, ROLES.OWNER, ROLES.BRANCH_ADMIN, ROLES.ACCOUNTANT],
      },
    ],
  },
  {
