...
export const branchSchema = z.object({
  ...
  code: requiredString('Branch code').max(10, 'Code must be 10 characters or less'),
...
export const categorySchema = z.object({
  ...
  code: requiredString('Category code').max(10, 'Code must be 10 characters or less'),
...
export const subCategorySchema = z.object({
  ...
  code: requiredString('Sub-category code').max(10, 'Code must be 10 characters or less'),
