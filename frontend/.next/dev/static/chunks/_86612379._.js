...
"[project]/src/components/accessibility/live-region.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function LiveRegion() {
    ...
    if ($[0] !== "94a41d8588dbd5f54e3b256b82b222eea388db1f8936b1f2f46d0618cb0a1359") {
        for(let $i = 0; $i < 10; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "94a41d8588dbd5f54e3b256b82b222eea388db1f8936b1f2f46d0618cb0a1359";
    }
    const [politeMessage, setPoliteMessage] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    const [assertiveMessage, setAssertiveMessage] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    let t0;
    let t1;
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
        t0 = ({
            "LiveRegion[useEffect()]": ()=>{
                const handleAnnounce = {
                    "LiveRegion[useEffect() > handleAnnounce]": (e)=>{
                        const { message, priority } = e.detail;
                        clearTimeout(announceTimeout);
                        if (priority === "assertive") {
                            setAssertiveMessage(message);
                            announceTimeout = setTimeout({
                                "LiveRegion[useEffect() > handleAnnounce > setTimeout()]": ()=>setAssertiveMessage("")
                            }["LiveRegion[useEffect() > handleAnnounce > setTimeout()]"], 1000);
                        } else {
                            setPoliteMessage(message);
                            announceTimeout = setTimeout({
                                "LiveRegion[useEffect() > handleAnnounce > setTimeout()]": ()=>setPoliteMessage("")
                            }["LiveRegion[useEffect() > handleAnnounce > setTimeout()]"], 1000);
                        }
                    }
                }["LiveRegion[useEffect() > handleAnnounce]"];
    ...
    if ($[3] !== politeMessage) {
        t2 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            fileName: "[project]/src/components/accessibility/live-region.tsx",
            lineNumber: 64,
            columnNumber: 10
        }, this);
        $[3] = politeMessage;
...
_s(LiveRegion, "qbnOzI0Nnhu7CRnOvEFxYFKWRTU=");
_c = LiveRegion;
var _c;
...
//# sourceMappingURL=_86612379._.js.map